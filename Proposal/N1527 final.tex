...
\hypersetup{pdftitle={N1527: Latency Reducing Memory Allocation in the C standard library}, pdfauthor={Niall Douglas}, pdfsubject={ISO/IEC JTC1/SC22/WG14}, pdfkeywords={C1X, N1527}}

\newcommand{\superscript}[1]{\ensuremath{^{\textrm{#1}}}}
\newcommand{\subscript}[1]{\ensuremath{_{\textrm{#1}}}}
\definecolor{changed}{rgb}{0,0.33,0}

\standard{ISO SC22/WG14 -- N1527: Latency Reducing Memory Allocation}
\yearofedition{\hfill [v1.93 Oct 2010]}
